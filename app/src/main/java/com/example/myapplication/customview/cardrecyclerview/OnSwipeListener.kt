...
interface OnSwipeListener<T> {
     ...
     */
    abstract fun onSwiping(viewHolder: RecyclerView.ViewHolder, ratio: Float, direction: Int)
     ...
     */
    abstract fun onSwiped(viewHolder: RecyclerView.ViewHolder, t: T, direction: Int)

    /**
     * 所有的卡片全部滑出时回调
     */
    abstract fun onSwipedClear()
}