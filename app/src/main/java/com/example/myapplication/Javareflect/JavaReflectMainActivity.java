package com.example.myapplication.Javareflect;
...
public class JavaReflectMainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.java_reflect);
    ...
    public void test2() {
        ...
        Log.i("baobao", "获取类的所有ctor，不分public还是private----------------------------------------------");
        ...
        Log.i("baobao", "获取类的所有public ctor----------------------------------------------");
        //获取类的所有public ctor
        try {
    ...
    void printCtor(Constructor theConstructor) {
        ...
        Log.i("baobao", Modifier.toString(mod)  + "(");
    ...
    public void test2_1() {
        ...
        try {
            Class r = Class.forName("com.example.myapplication.Javareflect.TestClassCtor");
    ...
    public void test5() {
        ...
        try {
            ...
            Class<?> singleton = Class.forName("com.example.myapplication.Javareflect.Singleton");
            Field mInstanceField = singleton.getDeclaredField("mInstance");
            mInstanceField.setAccessible(true);

            //获取AMN的gDefault单例gDefault，gDefault是静态的
            Class<?> activityManagerNativeClass = Class.forName("com.example.myapplication.Javareflect.AMN");
            ...
            Class<?> classB2Interface = Class.forName("com.example.myapplication.Javareflect.ClassB2Interface");
